...
$theme: (
  ...
  line-height: 1.25,
  color-border:#33485c,
  color-header-bg:#2e384a,
  color-bg: #ffffff,
  color-bg-active: #e9edf2,
  color-fg: #a4abb3,
  color-sidebar-bg:#425069,
